<template>
  <modal :classes="['delete-my-images']" name="altText" @closed="onClose">
    ...
    <p class="px-4" style="font-size: 14px">
      Alt text improves your search engine optimization(SEO) and describes your
      image for visitors with visual impairments.
    </p>
    <hr />
