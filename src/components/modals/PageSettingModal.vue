<template>
  <modal :classes="['page-setting-modal']" name="page-setting-modal" style="height: auto" @closed="onClose()">
    ...
    <div>
      <bz-tabs>
        <bz-tab label="Properties">
          ...
          <bz-input v-model="page_url" label="Page Url" :height="40" class="mt-4" prefix="/" v-show="activePage.url" />
          <small v-show="!uniqueUrl" style="text-transform: lowercase; color: #ff1744">This url is already used</small>
        </bz-tab>
        <bz-tab label="Seo">
          <div class="seo-container">
            <p>Improve the way this page shows up in search results by setting a good title and description.</p>
