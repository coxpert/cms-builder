<template>
  <modal
    width="90%"
    :classes="['bz-modal--contact-form-setting-root']"
    name="contact-form-setting-modal"
    @closed="onClose()"
  >
    ...
    <div style="height: calc(100% - 115px); overflow-y: auto">
      <md-tabs>
        <md-tab id="tab-form-fields" md-label="Form Fields">
          <div class="col-12">
            <bz-warning class="my-3">
              Enable or disable specific form field types, as well as provide a
              custom label for them.
            </bz-warning>
          </div>
          <div class="col-12">
            <div class="row">
              <div class="col-9">
                <bz-input
                  v-model="form.formFields.firstName.label"
                  label="First Name"
                />
              </div>
              ...
              <div class="col-9">
                <bz-input
                  v-model="form.formFields.lastName.label"
                  label="Last Name"
                />
              </div>
              <div class="col-3 d-flex align-items-center justify-content-end">
              ...
              <div class="col-9">
                <bz-input
                  v-model="form.formFields.subject.label"
                  label="Subject"
                />
              </div>
              <div class="col-3 d-flex align-items-center justify-content-end">
              ...
              <div class="col-9">
                <bz-input
                  v-model="form.formFields.message.label"
                  label="Message"
                />
              </div>
              <div class="col-3 d-flex align-items-center justify-content-end">
              ...
              <div class="col-9">
                <bz-input
                  v-model="form.formFields.address.label"
                  label="Address"
                />
              </div>
              <div class="col-3 d-flex align-items-center justify-content-end">
        ...
        <md-tab id="tab-form-address" md-label="Form Address">
          <div class="col-12">
            <bz-warning class="my-3">
              Emails get sent to the email address attached to your account by
              default. You can change the email address for this contact form in
              the field below
            </bz-warning>
          </div>
          <div class="col-12">
        ...
        <md-tab id="tab-success-message" md-label="Success message">
          <div class="col-12">
            <bz-warning class="my-3">
              This is the message you present to users when they have
          ...
          <div class="col-12">
            <bz-input
              v-model="form.successMessage.message"
              :label="'Message'"
              :multiple="true"
              :rows="4"
            />
        ...
        <md-tab id="tab-permission-message" md-label="Permission message">
          <div class="col-12">
            <bz-warning class="my-3">
              Add a custom message to inform users they need to give their
              permission to be contacted.
            </bz-warning>
          </div>
          <div class="col-12">
            <bz-input
              v-model="form.permissionMessage"
              :label="'Title'"
              :multiple="true"
              :rows="3"
            />
...
export default {
  ...
  components: { BzSwitch, BzInput, BzWarning, CloseIcon },
  ...
  methods: {
    ...
    onConfirm() {
      this.$store.state.contactFormSetting.onChange(this.form);
      this.onClose();
    },
  },
};
