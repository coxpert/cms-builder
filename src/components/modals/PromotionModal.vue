            ...
            <div class="bz-row">
              ...
              <div class="bz-col-12 my-4">
                <bz-input
                  label="Title"
                  :height="40"
                  v-model="promotion.successMessage.title"
                />
              </div>
              <div class="bz-col-12 my-4">
                <bz-input
                  ...
                  :multiple="true"
                  :rows="5"
                  v-model="promotion.successMessage.message"
                />
              </div>
              <div class="bz-col-12 my-4">
                <bz-input
                  ...
                  :multiple="true"
                  :rows="5"
                  v-model="promotion.successMessage.footNote"
                />
              </div>
            </div>
          </div>
              ...
              <div class="bz-row">
                ...
                <div class="bz-col-12 my-4">
                  <bz-input
                    ...
                    :multiple="true"
                    :rows="5"
                    v-model="promotion.permissionMessage"
                  />
                </div>
              </div>
            </div>
