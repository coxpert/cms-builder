<template>
  ...
  >
          ...
          <div class="bz-col-12">
            <div class="bz-row">
              <p>
                ...
                default. You can change the email address for this contact form
                in the field below
              </p>
            ...
            <div class="bz-row">
              ...
              <div class="bz-col-12 my-4">
                <bz-input
                  label="Title"
                  :height="40"
                  v-model="subscribe.successMessage.title"
                />
              </div>
              <div class="bz-col-12 my-4">
                <bz-input
                  ...
                  :multiple="true"
                  :rows="5"
                  v-model="subscribe.successMessage.message"
                />
              </div>
            </div>
          </div>
              ...
              <div class="bz-row">
                ...
                <div class="bz-col-12 my-4">
                  <bz-input
                    ...
                    :multiple="true"
                    :rows="5"
                    v-model="subscribe.permissionMessage"
                  />
                </div>
              </div>
            </div>
    ...
    <div class="w-100 d-flex justify-content-end">
      ...
      <button
        class="btn btn-success mr-4 d-flex align-items-center"
        @click="onConfirm()"
      >
        <b>Save</b>
      </button>
