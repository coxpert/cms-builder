<template>
  ...
  >
      ...
      <div class="add-marker-panel">
        <div class="add-marker-header">
          <div class="w-100 p-2 d-flex justify-content-end">
            ...
            <close-icon :size="22" @click="onClose" />
          </div>
        </div>
    ...
    <div class="w-100 d-flex justify-content-between">
      <div>
        <button
          class="btn bz-btn-default ml-3 px-5 d-flex align-items-center"
          @click="onConfirm()"
        >
          <b>Add marker</b>
        </button>
      ...
      <div class="d-flex">
        ...
        <button
          class="btn bz-btn-default mr-3 d-flex align-items-center"
          @click="onConfirm()"
        >
          <b>Save</b>
        </button>
...
export default {
  name: "manage-markers-modal",
  components: { BzSelect, BzInput, CloseIcon, DeleteIcon, DuplicateIcon },
  data() {
    return {
      loading: false,
      markers: [],
