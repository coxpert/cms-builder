    ...
    <div v-if="openColorPanel" class="color-panel">
      ...
      <div class="color-item" @click="handleItemClick(customColor)">
        <div
          ...
          :class="{ active: textColor === customColor }"
        ></div>
      </div>
  ...
  created() {
    ...
    document.addEventListener("mouseup", function () {
      ...
      if (selection.anchorNode) {
        ...
        const decoration = computedStyle.getPropertyValue(
  ...
  methods: {
    ...
    isEditorElement: function (element) {
      return (
        ...
        element.getAttribute("data-editor-element")
      );
    },
    ...
    isBlockContainer(element) {
      return (
        element &&
        element.nodeType !== 3 &&
        this.blockContainerElementNames.indexOf(
