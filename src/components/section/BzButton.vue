...
export default {
  ...
  computed: {
    ...
    buttonBackgroundColor() {
      let backgroundColor = this.data.backgroundColor || this.buttonColor;
      if (this.theme.isAdvanced) {
        backgroundColor =
          backgroundColor || this.theme[this.themeMode].buttonColor;
      } else {
        backgroundColor =
          backgroundColor || this.theme[this.themeMode].primaryColor;
      }
    ...
    buttonStyle() {
      return {
        ...
        "--bz-button-color": window.getHoverColor(this.buttonBackgroundColor),
      };
    },
    _textColor() {
      if (this.textColor) {
...
.bz-el--button-root {
  ...
  .button {
    ...
    &:hover {
      background-color: var(--bz-button-color) !important;
      border-color: var(--bz-button-color) !important;
    }
