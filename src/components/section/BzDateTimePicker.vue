<template>
  <div @click="calendarClicked($event)" v-click-outside="hiddenCal" :style="{ width: width }" class="datetime-picker">
    <div v-if="$slots.default" @click="toggleCal">
      <slot />
    </div>
    <input v-else type="text" :readonly="readonly" id="tj-datetime-input" :required="required" :value="date" :name="name" v-on:click="toggleCal" autocomplete="off" />
    <div class="calender-div" :class="{ noDisplay: hideCal }">
      <div class="calender-wrapper" :class="{ noDisplay: hideDate }">
        ...
        <table class="calender-table">
          <thead>
            <tr>
              <th class="days" v-for="port in days" :key="port">{{ port }}</th>
            </tr>
          </thead>
          <tbody>
            <tr class="week" v-for="(week, weekIndex) in weeks" :key="weekIndex">
              <td
                class="port"
        ...
        <div class="time-picker" :class="{ noDisplay: hideTime }">
          <div class="hour-selector">
            <bz-select label="Hours" variant="white" v-model="hour" :options="hours" />
          </div>
          <div class="minute-selector">
            <bz-select label="Minutes" variant="white" v-model="minute" :options="minutes" />
          </div>
        </div>

        <div class="button-group">
          <button type="button" v-on:click="clearDate" class="cancel-button">Cancel</button>
          <button type="button" v-on:click="setDate" class="save-button">Save</button>
        </div>
      </div>
    </div>
  </div>
