<template>
  <bz-setting :edit="edit" @click="handleNavigationClick">
    ...
    >
      <template v-for="(navigation, index) of value">
        <div :key="index" class="navigation-item" :class="{ edit }">
          ...
          <div
            ...
            class="dropdown"
            :class="{ open: openedIndex === index }"
          >
            <div v-if="navigation.children?.length > 0" class="top-arrow"></div>
            <bz-navigation-item
              v-for="(item, itemIndex) of navigation.children"
              :key="itemIndex"
              :item="item"
            />
          </div>
...
import BzNavigationItem from "./BzNavigationItem";
import BzSetting from "../section/BzSetting";
import BzLink from "../section/BzLink";
