  ...
  <div class="flex-column h-100" style="display: flex">
    ...
    <div class="w-100 h-100">
      <md-tabs id="businesses" :md-active-tab="activeSubTab">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="d-flex justify-content-end align-items-center">
                  ...
                  <button class="btn bz-btn-default" @click="saveBusiness">
                    Apply
                  </button>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input
                    v-model="business.contact.phoneNumber"
                    class="form-control"
        ...
        <md-tab id="tab-business-hours" md-label="Business Hours">
          <div class="p-3">
...
export default {
  ...
  components: { BusinessHoursEditor, BzCloseIcon },
  mixins: [builderMixin],
  props: {
    activeBusinessIndex: {
      type: Number,
  ...
  computed: {
    activeSubTab: {
      get() {
        ...
        if (
          ["tab-address", "tab-contact", "tab-business-hours"].includes(
            activeSubTab
          )
        ) {
          return activeSubTab;
  ...
  methods: {
    handleCountyChange(event) {
      ...
      this.selectedCountry = this.allCountries.find(
        (countryItem) => countryItem.iso === isoCountryCode
      );
      this.business.country = this.selectedCountry.nicename;
      this.autoCompleteOptions.componentRestrictions.country =
    ...
    async getCoordinates(address) {
      ...
      return new Promise((resolve) => {
        ...
        let fetchUrl = `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyCloxJK3aIK9c7wNMn1wVnGCDHXh8Xei1c`;
    ...
    async saveBusiness() {
      ...
      if (this.activeBusinessIndex === -1) {
        if (
          this.templateSetting.businesses.some(
            (item) => item.companyName === this.business.companyName
          )
        ) {
        ...
        this.$toast.success("Added a new address");
      } else {
        this.templateSetting.businesses[this.activeBusinessIndex] =
          this.business;
