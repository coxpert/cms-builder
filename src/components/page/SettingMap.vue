<template>
  <div class="m-accordion__item">
    ...
    >
      ...
      <div
        v-if="setting.map.hasOwnProperty('zoomLevel')"
      ...
      <div
        v-if="setting.map.hasOwnProperty('type')"
        class="d-flex justify-content-between align-items-center mb-4"
      >
        <div class="row">
          <div class="col-5 d-flex align-items-center">
          ...
          <div class="col-7">
            <bz-select
              v-model="setting.map.type"
              :options="setting.map.mapTypes || ['roadmap', 'satellite']"
            />
          </div>
        </div>
      </div>
      ...
      <div
        v-if="setting.map.hasOwnProperty('grayscale')"
        class="d-flex justify-content-between align-items-center mb-4"
      >
      ...
      <div
        v-if="setting.map.hasOwnProperty('zoomControl')"
        class="d-flex justify-content-between align-items-center mb-4"
      >
