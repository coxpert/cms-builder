<template>
  <div
    ref="viewRef"
    class="bz-page bz-page-view-content"
    :class="{ open: openSlider, close: !openSlider }"
    @wheel="handleWheel"
  >
    <div class="wrapper" :style="wrapperStyle">
      <div
        v-for="(list, key) of dataList"
        v-show="list.type !== 'module'"
        id="main_content"
        :key="key"
        ref="mainContent"
      ...
      >
        <div class="sections-wrapper">
          <header
            class="page-browser-bar"
            :style="{ height: (35 / scale) * 0.8 + 'px' }"
            @click="handlePageBrowserBarClick(key)"
          >
            <div
              class="fake-browser-bar text-black"
          ...
          >
            <div
              v-for="(section, position) in list[list.listName]"
              :ref="'sectionRef' + key"
              :key="position"
              class="bz-content-section list-group-item"
            >
