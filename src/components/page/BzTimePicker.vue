      ...
      <div class="bz-time-picker_wrap">
        <div class="bz-time-picker_picker">
          <div class="bz-time-picker_header">
            <span
              :class="{ active: mode === 3 }"
              class="bz-time-picker_text bz-time-picker_text--pointer"
              @click.prevent="mode = 3"
              >{{ hour }}</span
            >
            ...
            <span
              :class="{ active: mode === 4 }"
              class="bz-time-picker_text bz-time-picker_text--pointer"
              @click.prevent="mode = 4"
              >{{ minute }}</span
            >
            <div class="bz-time-picker_pm-or-am">
              <span
                class="bz-time-picker_text bz-time-picker_text--sm bz-time-picker_text--pointer"
                :class="{ active: !isPm }"
                @click="isPm = false"
              >
                AM
            ...
            <div class="bz-time-picker_clock">
              ...
              >
                <li
                  ...
                  :class="{
                    active:
                      mode === 3 ? hour === time.point : minute === time.point,
                  }"
                >
                  {{ time.point }}
                </li>
          ...
          <div class="bz-time-picker_buttons">
            <button class="bz-time-picker_button" @click="handleCancel">
              Cancel
            </button>
...
export default {
  ...
  computed: {
    ...
    displayedValue() {
      const isValueFormattedPassed =
        this.$options.propsData.hasOwnProperty("valueFormatted");
  ...
  methods: {
    ...
    handleOk() {
      ...
      let a = this.isPm ? "pm" : "am";
      let time = `${hours}:${minutes} ${a}`;
      this.$store.state.timePicker.onChange(time);
      this.$store.commit("closeTimePicker");
    },
  },
  mounted() {
    let time = this.$store.state.timePicker.time || "09:25 AM";
