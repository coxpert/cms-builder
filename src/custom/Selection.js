    ...
    const Selection = {
      ...
      exportSelection: function (root, doc) {
        ...
        if (selection.rangeCount > 0) {
          ...
          const trailingImageCount = this.getTrailingImageCount(
            root,
            selectionState,
            range.endContainer,
            range.endOffset
          ...
          if (start !== 0) {
            const emptyBlocksIndex = this.getIndexRelativeToAdjacentEmptyBlocks(
              doc,
              root,
      ...
      getIndexRelativeToAdjacentEmptyBlocks: function (
        ...
        if (node) {
          ...
          const previousSibling = MediumEditor.util.findPreviousSibling(node);
      ...
      getCaretOffsets: function getCaretOffsets(element, range) {
        let preCaretRange, postCaretRange;
