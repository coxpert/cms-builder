module.exports = {
  init: function (MediumEditor) {
    ...
    const pasteBinDefaultContent = "%ME_PASTEBIN%";
    let lastRange = null;
    let keyboardPasteEditable = null;
    ...
    */
    ...
    const PasteHandler = MediumEditor.Extension.extend({
      /* Paste Options */
      ...
      handlePaste: function (event, editable) {
        ...
        let pastedHTML = clipboardContent["text/html"];
      ...
      handlePasteBinPaste: function (event) {
        ...
        let pastedHTML = clipboardContent["text/html"];
        const pastedPlain = clipboardContent["text/plain"];
        const editable = keyboardPasteEditable;
      ...
      createPasteBin: function (editable) {
        ...
        const pasteBinElm = this.document.createElement("div");
      ...
      removePasteBin: function () {
        ...
        const pasteBinElm = this.getPasteBin();
        if (!pasteBinElm) {
          return;
        }
      ...
      getPasteBinHtml: function () {
        ...
        const pasteBinHtml = pasteBinElm.innerHTML;
      ...
      cleanPaste: function (text) {
        ...
        let tmp;
        let workEl;
        const multiline = /<p|<br|<div/.test(text);
        const replacements = [].concat(
