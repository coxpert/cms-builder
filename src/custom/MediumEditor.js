    ...
    (function () {
      ...
      function handleDisabledEnterKeydown(event, element) {
        if (
          ...
          const node = MediumEditor.selection.getSelectionStart(
      ...
      function initExtensions() {
        ...
        if (!toolbarExtension && isToolbarEnabled.call(this)) {
          ...
          const toolbarOptions = MediumEditor.util.extend(
            {},
      ...
      function execActionInternal(action, opts) {
        ...
        if (action === "image") {
          const src = this.options.contentWindow
            .getSelection()
            .toString()
            .trim();
          return this.options.ownerDocument.execCommand(
        ...
        if (action === "html") {
          const html = this.options.contentWindow
            .getSelection()
            .toString()
            .trim();
        ...
        if (justifyAction.exec(action)) {
          const result = this.options.ownerDocument.execCommand(
            action,
            false,
            null
          );
          const parentNode = MediumEditor.selection.getSelectedParentElement(
      ...
      function cleanupJustifyDivFragments(blockContainer) {
        ...
        let textAlign;
        const childDivs = Array.prototype.slice
      ...
      MediumEditor.prototype = {
        ...
        execAction: function (action, opts) {
          ...
          if (match) {
            ...
            result = execActionInternal.call(
              this,
              (match && match[1]) || action,
              opts
            );
          ...
          const currentEditor = MediumEditor.selection.getSelectionElement(
        ...
        selectAllContents: function () {
          let currNode = MediumEditor.selection.getSelectionElement(
            this.options.contentWindow
          );
        ...
        selectElement: function (element) {
          ...
          const selElement = MediumEditor.selection.getSelectionElement(
            this.options.contentWindow
          );
          if (selElement) {
            ...
            if (targetUrl && targetUrl.trim().length > 0) {
              ...
              if (currentSelection) {
                ...
                if (
                  ...
                  const leadingWhitespacesCount =
                    (fragment.firstChild.innerHTML.match(/^\s+/) || [""])[0]
                      .length;
        ...
        addElements: function (selector) {
          ...
          const elements = createElementsArray(
            selector,
            this.options.ownerDocument,
            true
          );
