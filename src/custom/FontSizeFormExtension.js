  ...
  init: function (MediumEditor) {
    ...
    const FontSizeForm = MediumEditor.extensions.button.extend({
      ...
      getButton: function () {
        ...
        fontIncreaseBtn.innerHTML =
          '<b><i><svg width="24" height="24" viewBox="0 0 24 24" fill="#555555"> <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg></i></b>';
        ...
        fontDecreaseBtn.innerHTML =
          '<b><i><svg width="24" height="24" viewBox="0 0 24 24" fill="#555555"><path d="M19 13H5v-2h14v2z"></path></svg></i></b>';
