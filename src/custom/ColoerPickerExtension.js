  ...
  init: function (MediumEditor) {
    ...
    const colorPicker = MediumEditor.extensions.form.extend({
        ...
        if (this.colorItems) {
          this.colorItems.forEach((item) => {
            ...
            const backgroundColor = window
              .getComputedStyle(ItemContent, null)
      ...
      createForm: function () {
        ...
        // Font Size Form (div)
        form.className =
          "medium-editor-toolbar-form medium-editor-toolbar-form-color-picker";
        form.id =
          "medium-editor-toolbar-form-color-picker-" + this.getEditorId();
        ...
        this.base.options.colors.forEach((color) => {
          ...
          colorItemElement.addEventListener(
            "click",
            this.handleClickColorItem.bind(this, color)
          );
