    ...
    const Toolbar = MediumEditor.Extension.extend({
      ...
      showToolbar: function () {
        if (this.buttons.includes("fontsize")) {
          const fontSizeExtension = this.base.extensions.find(
            (ex) => ex.fontSizeBox
          );
          ...
          fontSizeExtension.fontSizeBox.innerHTML =
            parseInt(fontSize.replace("px", "")) + "px";
        }

        if (this.buttons.includes("colorPicker")) {
          const colorPickerExtension = this.base.extensions.find(
            (ex) => ex.name === "colorPicker"
          );
      ...
      multipleBlockElementsSelected: function () {
        ...
        const regexBlockElements = new RegExp(
          "<(" +
            MediumEditor.util.blockContainerElementNames.join("|") +
            ")[^>]*>",
          "g"
        );
        const selectionHTML = MediumEditor.selection
      ...
      checkState: function () {
        ...
        // hide toolbar
        const selectionElement = MediumEditor.selection.getSelectionElement(
          this.window
        );
        if (
          !selectionElement ||
      ...
      checkActiveButtons: function () {
        ...
        let queryState = null;
        const selectionRange = MediumEditor.selection.getSelectionRange(
          this.document
        );
        let parentNode;
      ...
      positionStaticToolbar: function (container) {
        ...
        if (this.sticky) {
          ...
          if (
            ...
            toolbarElement.style.top =
              this.stickyTopOffset - OffsetToolbarVertical + "px";
            // Normal static toolbar position
          } else {
            toolbarElement.classList.remove("medium-editor-sticky-toolbar");
            toolbarElement.style.top =
              containerTop - toolbarHeight - OffsetToolbarVertical + "px";
          }
        } else {
          toolbarElement.style.top =
            containerTop - toolbarHeight - OffsetToolbarVertical + "px";
