  ...
  init: function (MediumEditor) {
    ...
    Events.prototype = {
      ...
      attachDOMEvent: function (targets, event, listener, useCapture) {
        const win = this.base.options.contentWindow;
      ...
      detachAllEventsFromElement: function (element) {
        const filtered = this.events.filter(function (e) {
          return (
            e &&
            e[0].getAttribute &&
      ...
      detachExecCommand: function () {
        ...
        const index = doc.execCommand.listeners.indexOf(
          this.execCommandListener
        );
        if (index !== -1) {
      ...
      wrapExecCommand: function () {
        ...
        const callListeners = function (args, result) {
          if (doc.execCommand.listeners) {
        ...
        const wrapper = function () {
          const result = doc.execCommand.orig.apply(this, arguments);
      ...
      cleanupElement: function (element) {
        const index = element.getAttribute("medium-editor-index");
        if (index) {
