<template>
  <div
    class="bz-section-container bz-sec--contact-form-7-root"
  ...
  >
    ...
    >
      <bz-container>
        <div class="bz-col-12">
          <div class="bz-row">
            <div class="bz-col-lg-8 bz-d-flex bz-column">
              <bz-contact-form v-model="data.form">
                ...
                >
                  ...
                  <div class="bz-d-flex bz-w-lg-70 bz-align-self-end">
                    <input
              ...
              <div class="bz-w-lg-70 bz-d-flex bz-align-self-end">
                <bz-alignment
                  :alignment="setting.layouts.alignment"
                  :stretch="false"
                >
