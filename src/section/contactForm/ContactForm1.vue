<template>
  <div class="bz-section-container bz-sec--contact-form-1-root" :class="{ [breakPoint]: true }" :data-section="section.id">
    <bz-background :setting="background" :size="sectionSize" :bzAnimationClass="setting.animationClass">
      <bz-container>
        <bz-alignment :alignment="setting.layouts.alignment" class="col-12">
        ...
        <div class="d-flex col-12">
          <input :id="'bz-checkbox-' + section.id" type="checkbox" class="m-1" />
        ...
        <bz-alignment :alignment="setting.layouts.alignment" class="col-12">
          <bz-button v-model="data.submitButton" :link="false" @click="handleSubmit" />
        </bz-alignment>
      </bz-container>
    </bz-background>
  </div>
