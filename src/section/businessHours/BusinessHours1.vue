<template>
  <div
    class="bz-section-container bz-sec-business-hours-1-root"
  ...
  >
    <bz-background :setting="background">
      <div class="col-12">
        <div
          class="row"
          :class="{ 'flex-row-reverse': setting.alignment === 'right' }"
        >
          <div class="col-lg-6">
            <bz-google-map
              v-if="setting.hasOwnProperty('map')"
              :type="setting.map.type"
              :zoom="setting.map.zoomLevel"
              :height="'100%'"
              :location="setting.map.location"
            />
          </div>
          <div class="col-lg-6">
            <div
              class="w-100 h-100 d-flex justify-content-around flex-column p-lg-4"
            >
              <bz-text-element
              ...
              <bz-business-hours
                v-if="setting.elements.businessHours"
