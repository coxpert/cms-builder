<template>
  <div class="bz-section-container bz-sec--usp-2-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
    <bz-background :setting="background" :size="sectionSize" :bzAnimationClass="setting.animationClass">
      <bz-container>
        ...
        <bz-items
          ...
          :spacing="setting.listElements.spacing"
          :styles="{ card: { padding: '30px', backgroundColor: '#ffffff' } }"
        >
