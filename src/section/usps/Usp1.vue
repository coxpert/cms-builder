<template>
  <div class="bz-section-container bz-sec--usp-1-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
      ...
      <bz-container>
        ...
        <bz-items v-model="data.items" :cols="setting.column" :shadow="false" :spacing="false">
          <template slot-scope="{ item, index }">
            <bz-alignment :alignment="setting.layouts.alignment">
              <div class="usp-item-container" v-if="setting.listElements.icon">
