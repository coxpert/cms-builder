<template>
  <div class="bz-section-container bz-sec--subscribe-4-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
          ...
          <div class="bz-col-12 bz-col-md-6 bz-col-lg-5 position-relative" style="z-index: 1">
            <bz-card :background-color="'#ffffff'" :padding="30">
              ...
              <bz-alignment :alignment="setting.layouts.alignment" :stretch="false" class="my-3">
                ...
                <bz-text v-model="data.elements.subtitle" v-if="setting.elements.subtitle" :background-color="'#ffffff'" />

                <bz-text v-model="data.elements.description" v-if="setting.elements.description" :background-color="'#ffffff'" />
              </bz-alignment>

              <bz-setting :on-click="openSubscribeModal">
