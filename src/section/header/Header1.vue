<template>
  <header class="bz-section-container bz-sec--header-1-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
    ...
    <div class="menu-container">
      <slide-up-down :active="openMenu" :duration="500">
        <div class="menu-content">
          ...
          <div v-if="setting.elements.loginButton" style="margin-top: 20px" @click="toggleMenu">
            <a href="/login">
              <span class="link-text">Login</span>
            </a>
          </div>
          <div v-if="setting.elements.registerButton" style="margin-top: 20px" @click="toggleMenu">
            <a href="/register">
