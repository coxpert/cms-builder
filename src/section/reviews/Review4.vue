<template>
  <div
    class="bz-section-container bz-sec--reviews-2-root"
            ...
            <div class="p-5">
              <bz-card :padding="40" class="position-relative">
                  ...
                  >
                    ...
                    >
                      <bz-setting :index="index" @click="openStarForm">
                        ...
                        <div
                          v-if="editing === index"
                          v-click-outside="hideReviewsEditForm"
                          class="bz-form-review-stars"
                        >
                ...
                <div class="bz-ee-button-container">
                  <bz-button import sectionMixin from '../mixins/sectionMixin'
                  v-model="data.items[index].button" :link="false"
                  v-if="setting.listElements.buttons" :rounded="true" />
                </div>
              </bz-card>
            </div>
          </template>
