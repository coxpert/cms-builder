<template>
  <div class="bz-section-container bz-sec--reviews-3-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
      ...
      <bz-container>
        ...
        <bz-items v-model="data.items" :cols="setting.column" :shadow="false">
          <template slot-scope="{ item, index }">
            ...
            <bz-image :ratio="1" v-model="data.items[index].image" width="80px" rounded v-if="setting.listElements.image" class="my-3" />
