<template>
  <div class="bz-section-container bz-sec--team-1-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
    <bz-background :setting="background" :size="sectionSize" :bzAnimationClass="setting.animationClass">
      <bz-container>
        ...
        <bz-items :shadow="setting.layouts.shadow" v-model="data.items" :cols="setting.column">
            ...
            <div class="col-12 bg-white">
              <div class="row">
                ...
                <div class="col-lg-4 p-0">
                  <bz-image v-model="data.items[index].image" v-if="setting.listElements.image" resize-mode="full" />
                </div>
              </div>
            </div>
          </template>
