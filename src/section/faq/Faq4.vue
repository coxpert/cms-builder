<template>
  <div
    class="bz-section-container bz-sec--faq4-root"
      ...
      <bz-container>
        ...
        <bz-items v-model="data.items" :cols="setting.column" :shadow="false">
          <template v-slot="{ index }">
            <div class="bz-faq-question-wrapper">
              <bz-title v-model="data.items[index].question" />
            </div>

            <bz-text v-model="data.items[index].answer" />
          </template>
        </bz-items>
      </bz-container>
    </bz-background>
