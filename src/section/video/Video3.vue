<template>
  <div
    class="bz-section-container bz-sec--video-3-root"
    ...
    <bz-background :size="sectionSize" :setting="background">
      <bz-container>
        <div class="elements-container">
          <div class="video-container" :class="setting.alignment">
            <bz-video v-model="data.video" />
          </div>
          <div class="elements-wrapper" :class="setting.alignment">
            <div class="bz-elements" :class="setting.alignment">
