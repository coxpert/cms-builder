<template>
  <div
    class="bz-section-container bz-sec-call-to-action-3-root"
  ...
  >
    ...
    >
      <bz-container>
        <bz-card :background-color="'#ffffff'" :padding="0">
          <div class="col-12">
            <div
              class="row"
            ...
            >
              <div class="col-lg-6 p-0">
                <bz-image v-model="data.elements.image" :ratio="2 / 3" />
              </div>
              <div class="col-lg-6 d-flex align-items-center">
                <div
                  class="content"
                  :class="{ [setting.layouts.alignment]: true }"
                >
                  <bz-title
