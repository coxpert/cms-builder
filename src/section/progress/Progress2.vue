<template>
  <div
    class="bz-section-container bz-sec--progress-2-root"
      ...
      <bz-container>
        ...
        <bz-items v-model="data.items" :cols="setting.column" :shadow="false">
          <template slot-scope="{ item, index }">
            <div
              class="bz-fl-progress"
              :class="{ edit }"
              :style="progressStyle(data.items[index].value)"
            >
              ...
              <div class="progress-value" v-if="setting.listElements.value">
              ...
              <div class="setting">
                <div
                  class="setting-icon"
                  @click.stop.prevent="openProgressEditForm(index)"
                >
