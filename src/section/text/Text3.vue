<template>
  <div
    class="bz-section-container bz-sect--text-3-root"
    :class="{ [breakPoint]: true }"
    :data-section="section.sectionUUID"
  >
    <div class="element-container">
      <bz-section-size :section-size="sectionSize">
        <bz-container>
    ...
    <bz-background :setting="background" class="mt-0 d-flex">
...
.bz-sect--text-3-root {
  ...
  .element-container {
    background-color: var(--bz-heading-color);
